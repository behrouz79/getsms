...
public class AdapterRequRec extends RecyclerView.Adapter<AdapterRequRec.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.btnRefresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sendRequest(holder.name.getText().toString(), Integer.parseInt(holder.currentId.getText().toString()));
            }
        });
    }
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        ...
        private TextView name, statusCode, date ,currentId;
    ...
    private void sendRequest(String msg_from, int uid) {
        ...
        request.sendSMS(params).enqueue(
                new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                        ...
                        db.smsDao().updateRecord(msg_from, sdf.format(c.getTime()), response.code(), uid);
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable t) {
                        Calendar c = Calendar.getInstance();
                        SimpleDateFormat sdf = new SimpleDateFormat("HH:mm yyyy-MM-dd");
                        db.smsDao().updateRecord(msg_from, sdf.format(c.getTime()), 500, uid);
